...
def scorecard():
    #------------------ READING THE FILES ------------------
    try:
        file_1 = open('teams.txt','r')
        Lines_1 = file_1.readlines()
        file_2 = open('india_inns2.txt', 'r')
        Lines_2 = file_2.readlines()
        file_3 = open('pak_inns1.txt','r')
    ...
    #------- Reading and converting the data from text file to dictionary --------------
        ...
        exit()
    try:
    #------------------Function to get the Batting/Bowling order of both the teams -------------
    ...
    #-----------------------Getting the bowling dataset for both the teams-------------------------
        def Bowling_Data_Set(index,List,List1):
            data = []
    ...
    #---------------------------------Getting the batting dataset for both the teams------------------------
        def Batting_Data_Set(index,List,List2):
            outs = 0
            data =[]
            data_set = pd.DataFrame(data,index = index, columns = [])
    ...
    try:
        ...
        India_Batting_set = Batting_Data_Set(India_Batting[0],India_Data,India_Batting[0])
        Pakistan_Batting_set = Batting_Data_Set(Pakistan_Batting[0],Pakistan_Data,Pakistan_Batting[0])

        #Bowling set for each team
        India_Bowling_set = Bowling_Data_Set(Pakistan_Batting[1],Pakistan_Data,Pakistan_Batting[1])
        Pakistan_Bowling_set = Bowling_Data_Set(India_Batting[1],India_Data,India_Batting[1])
        ...
        India_fall_of_wickets = Fallofwickets(India_Data)
        Pakistan_fall_of_wickets = Fallofwickets(Pakistan_Data)
